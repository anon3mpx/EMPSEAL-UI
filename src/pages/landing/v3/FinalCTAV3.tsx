// ─── Final CTA v3 — same as v2, real approved logo in the footer ───────────
//
// v2's FinalCTA uses the design-system's generic BrandMark (3 rounded bars,
// not the actual mark). Everywhere else on v3 the assets are real; the
// footer should be too.

import MagneticButton from "../v2/MagneticButton";
import { SocialTray, type SocialLink } from "../../../design-system/components";
...
export default function FinalCTAV3() {
  return (
    <section className="relative w-full py-32 md:py-48 px-6 md:px-12 overflow-hidden" style={{ background: "#05050c" }}>
      <div
        className="absolute inset-0 z-0 pointer-events-none"
        style={{ background: "radial-gradient(ellipse 80% 70% at 50% 100%, rgba(255,138,0,0.18) 0%, transparent 65%)" }}
      />
      ...
      <div className="relative max-w-6xl mx-auto z-10 text-center">
        ...
        <h2
          ...
          style={{
            ...
            textShadow: "0 0 80px rgba(255, 138, 0, 0.4), 0 0 160px rgba(255, 138, 0, 0.12)",
          }}
        >
          Plug in.{" "}
          <span className="italic" style={{ color: "#FF8A00", fontFamily: "'Instrument Serif', serif", letterSpacing: "-0.02em" }}>
            Earn.
          </span>{" "}
          Ship.
        </h2>
